 ...
 *	--------------------------------------------------------
 */
// old baseurl = "http://3.132.0.157/"
//old baseurl = http://13.58.154.146/
//new baseurl = http://18.189.237.157/promoted/public/api/auth/login
//http://18.218.201.50/promoted/public/login
let kImageDownloadURL         = "http://3.138.147.7/"
let kBASEURL                  = "http://18.189.237.157/"
