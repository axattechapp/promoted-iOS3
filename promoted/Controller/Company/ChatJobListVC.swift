...
class ChatJobListVC: BaseViewController,UITableViewDelegate,UITableViewDataSource {
...
//           NumOfDays += 1
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        //self.listTbl.reloadData()
            let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "ChatListVC") as? ChatListVC
