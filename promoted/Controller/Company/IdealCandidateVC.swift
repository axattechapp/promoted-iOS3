...
class IdealCandidateVC: BaseViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    @IBAction func criteriaClicked(_ sender: UIButton) {
...
//           NumOfDays += 1
        cell.date.text = "\(NumOfDays) days ago"
