...
class ChatScreenVC: BaseViewController,UITableViewDelegate,UITableViewDataSource,UITextViewDelegate, UIImagePickerControllerDelegate,UIDocumentPickerDelegate{
...
//        }
    ...
    @IBAction func sendClicked(_ sender: UIButton) {
        ...
        if textview.text! == "" || textview.text == "Write your message"{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if receiver_id == obj.receiver_id {
            if obj.is_file == 0 {
                ...
                let trimmedString = imageurl.removeWhitespace()
...
extension ChatScreenVC:UINavigationControllerDelegate{
