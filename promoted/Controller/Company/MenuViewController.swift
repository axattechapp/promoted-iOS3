...
class MenuController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func updateArrayMenuOptions(){
        arrayMenuOptions.append(["title":"Company Account", "icon":"Group 339"])
        arrayMenuOptions.append(["title":"Job Listing", "icon":"menu2"])
        arrayMenuOptions.append(["title":"Candidate Shortlist", "icon":"menu3"])
        arrayMenuOptions.append(["title":"Company Information", "icon":"menu4"])
