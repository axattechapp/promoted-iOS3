//
//  userNotificationDetailVC.swift
//  promoted
//
...
class userNotificationDetailVC: BaseViewController2,UITextViewDelegate {
    ...
    @IBAction func selectCompanyClicked(_ sender: UIButton) {
        ...
        if NotificationStatus == "" && Note == ""{
            ...
            let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "userNotificationCompanyVC") as? userNotificationCompanyVC
