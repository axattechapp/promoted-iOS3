...
public struct YPImagePickerConfiguration {
    ...
    public var screens: [YPPickerScreen] = [.library, .video]
    ...
    public var videoMinimumTimeLimit: TimeInterval = 1.0
    ...
    public var trimmerMinDuration: Double = 1.0
    ...
    public var libraryMediaType = YPlibraryMediaType.video
